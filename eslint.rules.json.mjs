...
export const jsonRules = {
  ...
  // Disallow duplicate keys in JSON objects	yes
  'json/no-duplicate-keys': 'error',
  // Disallow empty keys in JSON objects	yes
  'json/no-empty-keys': 'error',
  // Disallow JSON keys that are not normalized	yes
  'json/no-unnormalized-keys': 'error',
  // Disallow JSON values that are unsafe for interchange	yes
